...
appDataDir = os.path.join(QStandardPaths.writableLocation(QStandardPaths.MusicLocation), 'BingNiceWallpapers')
# print(appDataDir)
            ...
            if sys.platform.startswith('win32'):
                ...
                try:
                    ...
                    win32gui.SystemParametersInfo(win32con.SPI_SETDESKWALLPAPER, newName, win32con.SPIF_UPDATEINIFILE |
                                                  win32con.SPIF_SENDCHANGE | win32con.SPIF_SENDWININICHANGE)  # 1+2 有啊,https://docs.microsoft.com/en-us/windows/win32/winmsg/about-windows#desktop-window
                    os.remove(imagePath)
...
def main():
    ...
    # app.setAttribute(Qt.AA_ShareOpenGLContexts)  # 防止crash
    # app.setAttribute(Qt.AA_UseSoftwareOpenGL)

    # app.setStyleSheet('QWidget {font-family:Lato,Helvetica Neue,Helvetica,Arial,sans-serif;}')#font-size:62pt;;     sans-serif  https://developer.mozilla.org/en-US/docs/Web/CSS/font-family   Arial,不用引号"Lucida Sans Unicode"多余字体往后接上 , serif;要指定QWidget才有效
    # app.setStyleSheet('QWidget {font-family:-apple-system, BlinkMacSystemFont, "PingFang SC", Helvetica, Tahoma, Arial, "Hiragino Sans GB", "Microsoft YaHei", 微软雅黑, SimSun, 宋体, Heiti, 黑体, sans-serif;}')#font-size:62pt;;     sans-serif  https://developer.mozilla.org/en-US/docs/Web/CSS/font-family   Arial,不用引号"Lucida Sans Unicode"多余字体往后接上 , serif;要指定QWidget才有效
    app.setStyleSheet('QWidget {font-family:"Microsoft YaHei";}')  # font-size:62pt;;     sans-serif  https://developer.mozilla.org/en-US/docs/Web/CSS/font-family   Arial,不用引号"Lucida Sans Unicode"多余字体往后接上 , serif;要指定QWidget才有效
