...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.timeEdit.setMaximumTime(QtCore.QTime(0, 59, 0))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "自动更换壁纸的时间间隔（分钟）"))
        self.timeEdit.setDisplayFormat(_translate("Dialog", "mm"))
